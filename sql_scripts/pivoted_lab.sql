    ...
    select
      ...
      , case
          ...
          and i.outtime_lag > (DATETIME_SUB(i.intime, INTERVAL '24 HOUR'))
            then DATETIME_SUB(i.intime, '1 SECOND'::interval * CAST(DATETIME_DIFF(i.intime, i.outtime_lag, 'SECOND')/2 AS bigint))
      ...
      , case
          ...
          and i.intime_lead < (DATETIME_ADD(i.outtime, INTERVAL '24 HOUR'))
            then DATETIME_ADD(i.outtime, '1 SECOND'::interval * CAST(DATETIME_DIFF(i.intime_lead, i.outtime, 'SECOND')/2 AS bigint))
    ...
    select
      ...
      , case
          ...
          and h.dischtime_lag > (DATETIME_SUB(h.admittime, INTERVAL '24 HOUR'))
            then DATETIME_SUB(h.admittime, '1 SECOND'::interval * CAST(DATETIME_DIFF(h.admittime, h.dischtime_lag, 'SECOND')/2 AS bigint))
      ...
      , case
          ...
          and h.admittime_lead < (DATETIME_ADD(h.dischtime, INTERVAL '24 HOUR'))
            then DATETIME_ADD(h.dischtime, '1 SECOND'::interval * CAST(DATETIME_DIFF(h.admittime_lead, h.dischtime, 'SECOND')/2 AS bigint))
