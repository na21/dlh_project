...
Copy 3 tables from raw MIMIC data to local mimic and change the column names to lowercase
```
...
Computing adversarial suspectability scores as done in the paper were not completed. The paper was not clear enough regarding input and general creation of these scores. However, the adversarial examples created from cw_main still offer some insight.

**Model insights:**
* Changing the learning rate from default 0.02 doesn't do much. 0.01 and 0.04 both had largely the same scores as 0.02.
